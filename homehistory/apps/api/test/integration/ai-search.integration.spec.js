...
const ai_search_service_1 = require("../../src/ai/services/ai-search.service");
...
describe('AI Search Integration (e2e)', () => {
    ...
    beforeAll(async () => {
        ...
        aiSearchService = moduleFixture.get(ai_search_service_1.AISearchService);
        await app.init();
        // Create test data
        ...
        testProperties = await Promise.all([
            (0, setup_1.createTestProperty)(testUser.id, {
...
//# sourceMappingURL=ai-search.integration.spec.js.map