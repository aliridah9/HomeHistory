...
describe('Testing Infrastructure', () => {
    it('should connect to test database', async () => {
        expect(setup_1.prisma).toBeDefined();
        expect(setup_1.prisma.$connect).toBeDefined();
    });
    ...
    it('should generate JWT token', () => {
        const token = (0, setup_1.generateTestToken)('test-user-123');
    ...
    it('should create multiple users without conflicts', async () => {
        // Create first user
        const user1 = await (0, setup_1.createTestUser)();
        expect(user1).toBeDefined();
        // Wait a moment to ensure different timestamps
        await new Promise(resolve => setTimeout(resolve, 10));
        // Create second user
        const user2 = await (0, setup_1.createTestUser)();
    ...
    it('should create property with user relationship', async () => {
        const user = await (0, setup_1.createTestUser)();
        const property = await (0, setup_1.createTestProperty)(user.id);
