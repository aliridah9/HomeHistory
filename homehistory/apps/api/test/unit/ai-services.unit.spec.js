...
const scoring_engine_service_1 = require("../../src/ai/services/scoring-engine.service");
const recommendation_service_1 = require("../../src/ai/services/recommendation.service");
const performance_monitoring_service_1 = require("../../src/ai/services/performance-monitoring.service");
const cache_optimization_service_1 = require("../../src/ai/services/cache-optimization.service");
const production_optimization_service_1 = require("../../src/ai/services/production-optimization.service");
const openai_service_1 = require("../../src/ai/services/openai.service");
const embedding_service_1 = require("../../src/ai/services/embedding.service");
const cache_manager_service_1 = require("../../src/ai/services/cache-manager.service");
const ai_database_service_1 = require("../../src/ai/services/ai-database.service");
...
describe('AI Services Unit Tests', () => {
    let module;
    let scoringEngineService;
    let recommendationService;
    let performanceMonitoringService;
    let cacheOptimizationService;
    let productionOptimizationService;
    beforeEach(async () => {
        module = await testing_1.Test.createTestingModule({
            providers: [
                ...
                production_optimization_service_1.ProductionOptimizationService,
                { provide: config_1.ConfigService, useValue: mockConfigService },
                { provide: prisma_service_1.PrismaService, useValue: mockPrismaService },
                { provide: cache_manager_service_1.CacheManagerService, useValue: mockCacheManagerService },
                { provide: ai_database_service_1.AIDatabaseService, useValue: mockAIDatabaseService },
                { provide: openai_service_1.OpenAIService, useValue: mockOpenAIService },
                { provide: embedding_service_1.EmbeddingService, useValue: mockEmbeddingService },
            ],
        }).compile();
        scoringEngineService = module.get(scoring_engine_service_1.ScoringEngineService);
        recommendationService = module.get(recommendation_service_1.RecommendationService);
        performanceMonitoringService = module.get(performance_monitoring_service_1.PerformanceMonitoringService);
        cacheOptimizationService = module.get(cache_optimization_service_1.CacheOptimizationService);
        productionOptimizationService = module.get(production_optimization_service_1.ProductionOptimizationService);
    });
    afterEach(async () => {
        await module.close();
        jest.clearAllMocks();
    ...
    describe('ScoringEngineService', () => {
        ...
        it('should generate score explanation', async () => {
            ...
            const explanation = await scoringEngineService.generateScoreExplanation('test-property-1', mockBreakdown);
    ...
    describe('RecommendationService', () => {
        ...
        it('should find similar properties', async () => {
            const recommendations = await recommendationService.findSimilarProperties('source-property', { limit: 5 });
        ...
        it('should calculate similarity between properties', async () => {
            ...
            const similarity = await recommendationService.calculateSimilarity(property1, property2);
        ...
        it('should diversify recommendation results', async () => {
            ...
            const diversified = recommendationService.diversifyResults(mockRecommendations, 0.3);
        ...
        it('should generate property embedding', async () => {
            const embedding = await recommendationService.generatePropertyEmbedding(mockProperty);
    ...
    describe('ProductionOptimizationService', () => {
        beforeEach(() => {
            ...
            productionOptimizationService.aiRequestQueue = mockQueue;
        });
        ...
        it('should handle fallback responses', async () => {
            ...
            const fallback = await productionOptimizationService.getFallbackResponse(mockRequest, new Error('Service unavailable'));
        ...
        it('should optimize vector queries', async () => {
            const result = await productionOptimizationService.optimizeVectorQuery('SELECT * FROM property_embeddings WHERE embedding <-> $1 < 0.5', [[0.1, 0.2, 0.3]]);
            expect(result).toBeDefined();
        });
    });
    describe('Error Handling', () => {
        ...
        it('should handle OpenAI API errors gracefully', async () => {
            ...
            const explanation = await scoringEngineService.generateScoreExplanation('test-property', mockBreakdown);
            expect(explanation).toBeDefined();
        ...
        it('should handle embedding generation failures', async () => {
            ...
            await expect(recommendationService.generatePropertyEmbedding({}))
                .rejects.toThrow();
        });
    });
    describe('Performance and Scalability', () => {
        it('should handle concurrent requests efficiently', async () => {
            const concurrentRequests = Array.from({ length: 10 }, (_, i) => scoringEngineService.calculateScore(`property-${i}`));
...
//# sourceMappingURL=ai-services.unit.spec.js.map