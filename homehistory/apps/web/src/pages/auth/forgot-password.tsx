  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Reset your HomeHistory account password. Enter your email to receive reset instructions." />
      </Helmet>
        ...
        <div className="w-full max-w-md mx-auto">
          <div className="bg-white rounded-2xl shadow-[0px_6px_24px_rgba(0,0,0,0.06),0px_0px_1px_rgba(0,0,0,0.03)] p-4 sm:p-6 relative">
            ...
            <div className="text-left mb-6">
              <h1 className="text-lg sm:text-xl font-semibold text-gray-900">Forgot your password?</h1>
            </div>
