...
export const useIsAdmin = () => useAuthStore((state) => 
  state.user?.role === UserRole.ADMIN || state.user?.role === UserRole.SUPER_ADMIN
)
export const useIsAgent = () => useAuthStore((state) => 
  state.user?.role === UserRole.AGENT || state.user?.role === UserRole.ADMIN || state.user?.role === UserRole.SUPER_ADMIN
)
