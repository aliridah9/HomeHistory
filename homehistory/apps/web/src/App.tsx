...
const ProfessionalSignup = React.lazy(
  () => import('./features/auth/components/ProfessionalSignup')
);
...
// const SSOCompletePage = React.lazy(() => import('@/features/auth/components/SSOComplete'));
// const ForgotPasswordPage = React.lazy(() => import('@/features/auth/components/forgot-password'));
// const ResetPasswordPage = React.lazy(() => import('@/features/auth/components/reset-password'));
    ...
    <NetworkProvider>
      <Helmet>
        ...
        <meta
          ...
          content="Discover property insights with AI-powered scoring, comprehensive history reports, and intelligent recommendations."
        />
